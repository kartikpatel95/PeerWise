...
document.getElementById('achievement_7').title = "Secret!";
document.getElementById('achievement_8').title = "Answer all!";
document.getElementById('achievement_9').title = "Non modivated!";
document.getElementById('achievement_10').title = "Answer 500 question!";
document.getElementById('achievement_11').title = "TBD";
document.getElementById('achievement_12').title = "TBD";
